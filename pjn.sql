...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 06, 2025 at 07:05 AM
...
CREATE TABLE `things` (
  ...
  `t_image` varchar(255) NOT NULL DEFAULT 'df.png',
...
CREATE TABLE `user` (
  ...
  `user_tell` int(255) NOT NULL,
  `user_image` varchar(255) DEFAULT 'df.png',
  `user_level` enum('techer','user','student','') NOT NULL DEFAULT 'user'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
